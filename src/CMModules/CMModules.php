<?php
/**
 * A model for managing Hakv modules.
 * 
 * @package Hakv
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $HakvCoreModules = array('CHakv', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $HakvCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isHakvCore']   = in_array($rc->name, $this->HakvCoreModules);
      $details['isHakvCMF']    = in_array($rc->name, $this->HakvCMFModules);
