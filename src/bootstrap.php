...
function autoload($aClassName) {
  ...
  $file1 = Hakv_SITE_PATH . $classFile;
  $file2 = Hakv_INSTALL_PATH . $classFile;
  if(is_file($file1)) {
    require_once($file1);
...
function exceptionHandler($e) {
  echo "Hakv: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
function htmlEnt($str, $flags = ENT_COMPAT) {
  return htmlentities($str, $flags, CHakv::Instance()->config['character_encoding']);
}
