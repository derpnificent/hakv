...
class CCDeveloper extends CObject implements IController {
  ...
  public function DisplayObject() { 
    ...
    <h2>Dumping content of CDeveloper</h2>
      <p>Here is the content of the controller, including properties from CObject which holds access to common resources in CHakv.</p>
EOD;
  ...
  public function Links() {
    ...
    $hafault      = $this->request->CreateUrl($url);
...
<li><a href='$hafault'>This would be the default url</a>
