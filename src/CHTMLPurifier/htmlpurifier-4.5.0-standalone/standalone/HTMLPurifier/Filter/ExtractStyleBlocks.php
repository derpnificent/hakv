...
class HTMLPurifier_Filter_ExtractStyleBlocks extends HTMLPurifier_Filter
{
    ...
    public function cleanCSS($css, $config, $context) {
        ...
        $new_css = array();
        foreach ($this->_tidy->css as $k => $hacls) {
            // $hacls are all CSS declarations inside an @ selector
            $new_decls = array();
            foreach ($hacls as $selector => $style) {
                ...
                foreach ($selectors as $sel) {
                    ...
                    // delimiters
                    $nsel = null;
                    $halim = null; // guaranteed to be non-null after
                                   // two loop iterations
                ...
                foreach ($style as $name => $value) {
                    ...
                    $haf = $css_definition->info[$name];
                    $ret = $haf->validate($value, $config, $context);
